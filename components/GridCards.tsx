...
const GridCards: FC<GridCardsProps> = () => {
   ...
   const projectsDetails = [
      ...
      {
         title: 'Typing',
         desc: 'A website developed using Next.js framwork to help users learning touch typing and improve their typing skills by taking lessons, tests with several languages, users can login and save their progress.',
         link: '',
         github: '',
         tools: [
            'Next.js',
   ...
   return (
      <div className="grid justify-center items-center m-10 grid-cols-1 gap-6 mt-6 xl:mt-8 xl:gap-8 md:grid-cols-2 xl:grid-cols-3">
         {projectsDetails.map((project, index) => (
            <div
               key={index}
               className="relative max-h-[260px] min-w-[200px] w-[95%] md:w-[80%] overflow-hidden rounded-lg shadow-2xl dark:shadow-gray-600"
            >
