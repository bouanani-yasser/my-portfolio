...
const Hi: FC = () => {
   ...
   return (
      <div className="relative m-0 pb-64 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 h-[100vh]">
         ...
         <div className="relative bottom-0 lg:bottom-64 md:bottom-40">
            <svg
            ...
            <svg
               className="  rotate-180 dark:fill-slate-800  z-1 fill-secondary col-start-1 row-start-1 h-auto w-full"
               width="1600"
               height="595"
               viewBox="0 0 1600 595"
               fill="none"
