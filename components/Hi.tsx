...
const Hi: FC = () => {
   ...
   return (
      <div className="relative -z-20 m-0 overflow-x-clip h-fit" id="hi">
         ...
         <div
            className="hidden dark:block w-full absolute top-10 h-[200vh] bg-secondary"
            style={{ clipPath: 'polygon(0 40%, 190% 0, 120% 25%, 0 90%)' }}
         ></div>
         <div className="block dark:hidden scale-150 absolute  md:scale-100 sm:mt-20 sm:top-80 md:top-64  lg:top-24 sm:-bottom-10 -z-10 lg:bottom-64 md:bottom-40">
            <svg
            ...
            <svg
               className="rotate-180 z-1 -translate-y-5 fill-secondary col-start-1 row-start-1 h-auto w-full"
               width="1600"
               height="595"
               viewBox="0 0 1600 595"
               fill="none"
